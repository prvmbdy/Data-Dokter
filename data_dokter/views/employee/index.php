...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <h1 class="mt-4 mb-4 text-center text-danger">Data Dokter Rhodes Island</h1>
                    ...
                    <form method="post" id="sample_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <span id="nation_error" class="text-danger"></span>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Specialist</label>
                                    <input type="text" name="specialist" id="specialist" class="form-control" />
                                    <span id="specialist_error" class="text-danger"></span>
                                </div>
                            <div class="mb-3">
            ...
            $.ajax({
                    ...
                    success: function(response) { 
                        ...
                        for (var i = 0; i < json.length; i++) {
                            var sub_array = {
                                'name' : json[i].name,
                                'nation' : json[i].nation,
                                'specialist' : json[i].specialist,
